...
const fetchMap = (lat, long) => {
  mapboxgl.accessToken = 'pk.eyJ1IjoiZW1pbHlnaWJsZXR0IiwiYSI6ImNrbWNoNWVyYzJibGcybnAxZGZrZDdvZm4ifQ.KySk7sVCXXxYK13LojsdGQ';
...
button.addEventListener("click", (event) => {
  fetch(`https://api.mapbox.com/geocoding/v5/mapbox.places/${address.value}.json?access_token=pk.eyJ1IjoiZW1pbHlnaWJsZXR0IiwiYSI6ImNrbWNoNWVyYzJibGcybnAxZGZrZDdvZm4ifQ.KySk7sVCXXxYK13LojsdGQ`)
